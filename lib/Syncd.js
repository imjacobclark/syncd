...
var Syncd = function(){
    this.etcd_endpoint              = "http://blog.jacob.uk.com:4001" //process.env.ETCD_ENDPOINT
    this.etcd_services_directory    = (process.env.ETCD_SERVICES_DIRECTORY != null) ? process.env.ETCD_SERVICES_DIRECTORY : "services"
    this.etcd_service_key           = "/v2/keys/" + this.etcd_services_directory + "/blog-jacob-uk-com" //+ process.env.ETCD_SERVICE_KEY;
    this.directory_to_sync          = "/Users/jacobclark/Desktop/syncd" //process.env.DIRECTORY_TO_SYNC;
    this.current_host_ip            = "noop" //process.env.CURRENT_HOST_IP;
            ...
            _this.getServices().then(function(data){
                for(var i = 0; i < data.node.nodes.length; i++){
                    ...
                    if(ip != _this.current_host_ip){ 
                        ...
                        exec("scp -r " + _this.directory_to_sync + " core@" + ip + ":/home/core/testing", this.log);
                    }
                }
            });
        }
